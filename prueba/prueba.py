...
def visualizar_histograma_var1():
    ...
    plt.hist(variable_1, bins=50, density=True, alpha=0.6, color="blue", edgecolor='black')
    ...
    plt.savefig("histograma_variable_1_con_momentos.png")
    plt.show()
...
def visualizar_histograma_var2():
    ...
    plt.hist(variable_2, bins=50, density=True, alpha=0.6, color="green", edgecolor='black')
    ...
    plt.savefig("histograma_variable_2_con_momentos.png")
    plt.show()
...
def modelosVar1():
    ...
    plt.hist(
        variable_1, bins=20, density=True, alpha=0.6,
        color="blue", label="Histograma"
    )
    ...
    plt.savefig("ajuste_variable_1_con_momentos.png")
    plt.show()
...
def modelosVar2():
    ...
    plt.figure(figsize=(10, 5))
    plt.hist(
        variable_2, bins=20, density=True, alpha=0.6,
        color="green", label="Histograma"
    )
    plt.plot(x, pdf, "r-", lw=2, label="PDF Ajustado")
    ...
    plt.savefig("ajuste_variable_2_con_momentos.png")
    plt.show()
